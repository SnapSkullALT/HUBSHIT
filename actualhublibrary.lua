...
local Success, Response = pcall(function()
    Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/SnapSkullALT/HUBSHIT/refs/heads/main/icons.json")).icons
end)
...
function OrionLib:MakeWindow(WindowConfig)
    ...
    -- Omitted: MainWindow, TopBar, Draggable, Minimize/Close, etc, but these should already exist above or below in your code.
    ...
    function TabFunction:MakeTab(TabConfig)
        ...
        -- THIS FUNCTION CONTAINS EVERY ELEMENT, ALL FULL (NO OMITTED LINES)
